...
const styles = {
  ...
  subtitle: { fontSize: '1rem', opacity: 0.85, marginBottom: '2rem', maxWidth: '600px', margin: '0 auto 2rem' },
  ...
  container: { maxWidth: '800px', margin: '-4rem auto 0', padding: '2rem 1rem', position: 'relative', zIndex: 1 },
