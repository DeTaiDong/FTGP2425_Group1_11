...
\begin{document}
	...
	\section{Conclusion}
	This project successfully built EcoPassEU, a decentralised application (DApp) that provides Digital Product Passports (DPPs) to meet the EU's Ecodesign for Sustainable Products Regulation (ESPR) \cite{EU2024ESPR}. By using Ethereum smart contracts \cite{Antonopoulos2018Mastering}, the system registers and verifies products automatically without relying on central authorities \cite{Szabo1997Formalizing}. To prevent false environmental claims, a \texttt{keccak256} hash securely links the immutable on-chain record to the full document on IPFS \cite{NIST2015SHA3}. Furthermore, running on Ethereum's Proof-of-Stake network aligns with the project's green goals by keeping energy use extremely low \cite{EthereumMerge2022,Buterin2019Casper,Saberi2019Blockchain}. This hybrid storage model also greatly reduces gas fees by keeping heavy data off the blockchain \cite{Kouhizadeh2021Blockchain}.
