...
\begin{document}
	...
	To reflect the theme of environmental protection, the page adopts a dark green colour scheme (\texttt{\#2d6a4f}, \texttt{\#1b4332}). 
	The layout uses standard \texttt{rem} spacing for a concise and consistent visual effect. 
	As shown in Figure~\ref{fig:ui_search}, the design of the homepage is concise and clear. Users can directly find the product ID through the central search bar without binding the wallet.
	
	\vspace{-0.2cm}
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.9\linewidth]{figures/5.png}
		\caption{Wireframe of the landing page and wallet-free search interface.}
		\label{fig:ui_search}
	\end{figure}
	\vspace{-0.2cm}
